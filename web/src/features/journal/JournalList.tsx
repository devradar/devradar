...
export function JournalList({ entries, hasMore, isInitialized, loadMore, deleteEntry, categoryFilter, setCategory, availableCategories, skillNameFilter, setSkillName }: JournalListProps) {
