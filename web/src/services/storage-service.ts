...
export const storageService = {
    ...
    getPaginatedEntries(page: number, pageSize: number, categoryFilter?: string, skillNameFilter?: string): UserActivity[] {
    ...
    updateEntry(id: string, updates: Partial<Omit<UserActivity, 'id' | 'created_at'>>): UserActivity | null {
        const storage = getStorage();
